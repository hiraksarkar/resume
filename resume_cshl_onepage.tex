...
\usepackage[showframe,right=1in,bottom=0.5in,top=0.75in,left=1in]{geometry}
\begin{document} 

 \moveleft.5\hoffset\centerline{\LARGE\bf Hirak Sarkar}   
 \address{8 Acorn Ln, Stony Brook, NY-11790\\Mob No.+1 6315208131}  \address{E-mail: \color{blue}  hiraksarkar.cs@gmail.com \\}    
...
%     {{\bf Ph.D in Computer Science}, Stony Brook University}  \>     \>2019 (expected)
%   \end{tabbing}  \vspace{-20pt}      % suppress blank line after tabbing
%  % {\bf Bachelor of Technology(Computer Science and Engineering)}  \\        
%       \vspace{-0.05in}	
%   \begin{tabbing}
%   \hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
%     {{\bf Masters of Technology (Computer Science)},Indian Statistical Institute  }  \>     \>2013 
%   \end{tabbing}  \vspace{-20pt}      % suppress blank line after tabbing
%  % {\bf Bachelor of Technology(Computer Science and Engineering)}  \\        
%             $1^{st}$ Class (Hons.) 
% \vspace{-0.17in}	
